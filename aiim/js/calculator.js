define(["dojo/_base/array", "dojo/_base/declare"], function(m, t) {
  return t(null, {
      ...
      processData: function(a) {
          ...
          this.xmin = 1234200.943; //IA: Hardcode extent of data points
          //this.ymin = a.extent.ymin;
          this.ymin = 8442828.1998; //IA: Hardcode extent of data points
          //this.xmax = a.extent.xmax;
          this.xmax = 1236424.2075; //IA: Hardcode extent of data points
          //this.ymax = a.extent.ymax;
          this.ymax = 8443809.57; //IA: Hardcode extent of data points
          this.cols = this.rows =
      ...
      _calcHeatmap: function() {
          if (this.features) {
              ...
              for (var a = this.dateField, b = [], c = 0, c = 0; 24 > c; c++) { //IA: Use hours
                  var g = m.filter(this.features, function(b) {
                          //b = (new Date(b.attributes[a])).getMonth();
                          b = (new Date(b.attributes[a])).getHours(); //IA: Use hours
                          return c === b
                      }),
