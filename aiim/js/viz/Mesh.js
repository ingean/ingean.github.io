define(["dojo/Evented", "dojo/_base/Color", "esri/core/declare", "esri/geometry/SpatialReference", "esri/views/3d/externalRenderers"], function(g, h, k, l, e) {
  return k([g], {
      ...
      calcHeatmap: function() {
          this.counter += .005;
          //1 <= this.counter && (this.counter = .005, this.slice += 1, 12 <= this.slice && (this.slice = 0));.005 === this.counter && this.emit("update", {
          1 <= this.counter && (this.counter = .005, this.slice += 1, 24 <= this.slice && (this.slice = 0));.005 === this.counter && this.emit("update", {
              slice: this.slice
          });
