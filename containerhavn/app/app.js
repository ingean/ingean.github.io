...
define([
    ...
    ToolsMenu, Welcome, queryTools) {
        ...
        var settings_demo = {
            name: "Containerhavn",
            url: "https://geodata.maps.arcgis.com",           // portal URL for config
            webscene: "bd1dfd02adb9403e9cde91eed810a869",   // portal item ID of the webscene
            usagename: "CONTENT",                             // usage attribute (string)
            floorname: "LEVEL_",                           // floor attribute (int)
            OIDname: "OBJECTID",                            // objectid
            buildingIDname: "CID",                   // building attribute (int)
            areaname: "CID",                           // area attribute (float)
        ...
        return declare(null, {
            ...
            init: function (settings) {
				...
				console.log(this.settings.webscene);
				...
				*/
                ...
                this.view.then(function () {
                    ...
                    this.settings.layer1 = this.scene.layers.getItemAt(1).layers.getItemAt(8);
					console.log(this.settings.layer1.id);
                    ...
                    this.settings.layer2.visible = true;
